...
def policy_net(input_shape, action_space, summary=False):
    ...
    main_output = Dense(action_space, activation='softmax', kernel_regularizer='l2', dtype='float64')(conv_part(state_input))
...
def critic_net(input_shape, epsilon, summary=False):
    ...
    x = Dense(512, activation='tanh', kernel_regularizer='l2', dtype='float64')(x)
